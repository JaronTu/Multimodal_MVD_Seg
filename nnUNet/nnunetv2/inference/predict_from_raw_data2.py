...
class nnUNetPredictor(object):
    ...
    def predict_logits_from_preprocecssed_data(self, data: torch.Tensor) -> torch.Tensor:
        """
...
def predict_entry_point_modelfolder():
    ...
    predictor.initialize_from_trained_model_folder(args.m, args.f, args.chk, args.sp)
