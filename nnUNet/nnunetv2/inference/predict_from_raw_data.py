...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        for i, f in enumerate(use_folds):
            ...
            parameters.append(new_state_dict)
    ...
    def predict_logits_from_preprocessed_data(self, data: torch.Tensor) -> torch.Tensor:
        ...
        # print(type(self.list_of_parameters))
        # self.list_of_parameters.pop('out2')
        # self.list_of_parameters.pop('out3')
        with torch.no_grad():
            prediction = None
    ...
    # def _internal_maybe_mirror_and_predict(self, x: torch.Tensor) -> torch.Tensor:
    #     mirror_axes = self.allowed_mirroring_axes if self.use_mirroring else None
    #     prediction1, prediction2, prediction3 = self.network(x)
    #
    #     if mirror_axes is not None:
    #         # print(mirror_axes)
    #         # exit()
    ...
    #         num_predictons = 2 ** len(mirror_axes)
    #         if 0 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (2,))), (2,))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         if 1 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (3,))), (3,))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         if 2 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (4,))), (4,))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         if 0 in mirror_axes and 1 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (2, 3))), (2, 3))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         if 0 in mirror_axes and 2 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (2, 4))), (2, 4))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         if 1 in mirror_axes and 2 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (3, 4))), (3, 4))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         if 0 in mirror_axes and 1 in mirror_axes and 2 in mirror_axes:
    #             prediction1, prediction2, prediction3 = torch.flip(self.network(torch.flip(x, (2, 3, 4))), (2, 3, 4))
    #             prediction1 += prediction1
    #             prediction2 += prediction2
    #             prediction3 += prediction3
    #         prediction1 /= num_predictons
    #         prediction2 /= num_predictons
    #         prediction3 /= num_predictons
...
def predict_entry_point():
    ...
    model_folder = get_output_folder(args.d, args.tr, args.p, args.c, args.sp)
    print("mod",model_folder)
