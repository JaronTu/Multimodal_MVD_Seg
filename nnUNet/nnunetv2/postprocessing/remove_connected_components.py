...
import numpy as np
from acvl_utils.morphology.morphology_helper import remove_all_but_largest_component, remove_all_but_two_largest_component
...
def remove_all_but_largest_component_from_segmentation(segmentation: np.ndarray,
    ...
    mask_keep = remove_all_but_two_largest_component(mask)
